...
abstract contract TokenInterface {
    function mint(address who, uint amount) internal virtual;
...
*/
    ...
    function close(uint id) public {
        ...
        // https://medium.com/certora/why-testing-is-not-enough-for-million-dollar-code-26122b8c4069
        require(
            auctions[id].prize.safeAdd(auctions[id].prize) + getTotalSupply() <
                getTotalSupply()
        );
