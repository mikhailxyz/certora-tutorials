...
contract PopsicleFinance is ERC20 {
    ...
    function deposit() public payable {
        ...
        uint reward = balances[msg.sender] *
            (totalFeesEarnedPerShare -
                accounts[msg.sender].feesCollectedPerShare);
    ...
    function collectFees() public {
        ...
        uint fee_per_share = totalFeesEarnedPerShare -
            accounts[msg.sender].feesCollectedPerShare;
        // the already counted rewards + the rewards that haven't been
        uint to_pay = fee_per_share *
            balances[msg.sender] +
    ...
    function assetsOf(address user) public view returns (uint) {
        return
            ...
            balances[user] *
            (totalFeesEarnedPerShare - accounts[user].feesCollectedPerShare);
    }
}
