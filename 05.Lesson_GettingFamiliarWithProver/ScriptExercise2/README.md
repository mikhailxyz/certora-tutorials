...
- [x] Run a verification of **_the same parametric rule_** in `meetings.spec` with the appropriate Solidity compiler and a message of your choice. Do not use the `--method` flag.
